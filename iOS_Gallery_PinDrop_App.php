    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div data-u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px;
          ...
          <!-- <div>
            ...
            <div> 
                <img data-u="image" src="http://slaaysourcecoders.in/img/gallery/PinDrop/map_2.jpg" alt="" />
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px;font-size: 50px;
                        color: #FFFFFF;">PinDrop App
                </div>
                <div style="position: absolute; width: 480px; height: 120px; top: 300px; left: 30px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 30px;
                        color: #FFFFFF;">
                        PinDrop may with pin found by the gamer!
                </div>
            </div>
            
            <div>
                <img data-u="image" src="http://slaaysourcecoders.in/img/gallery/PinDrop/map_3.jpg" alt="" />
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; font-size: 50px;
                        color: #FFFFFF;">PinDrop App
                </div>
                <div style="position: absolute; width: 480px; height: 120px; top: 300px; left: 30px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 30px;
                        color: #FFFFFF;">
                         PinDrop launch screen!
                </div>
            </div>

            <div>
                <img data-u="image" src="http://slaaysourcecoders.in/img/gallery/PinDrop/map_4.jpg" alt="" />
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; font-size: 50px;
                        color: #FFFFFF;">PinDrop App
                </div>
                <div style="position: absolute; width: 480px; height: 120px; top: 300px; left: 30px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 30px;
                        color: #FFFFFF;">
                       Pins that the user has tapped will appear greeen!
                </div>
            </div>

            <div>
                <img data-u="image" src="http://slaaysourcecoders.in/img/gallery/PinDrop/map_5.jpg" alt="" />
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; font-size: 50px;
                        color: #FFFFFF;">PinDrop App
                </div>
                <div style="position: absolute; width: 480px; height: 120px; top: 300px; left: 30px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 30px;
                        color: #FFFFFF;">
                       PinDrop App iOS icon!
                </div>
            </div>

            <div>
                <img data-u="image" src="http://slaaysourcecoders.in/img/gallery/PinDrop/map_1.jpg" alt="" />
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px;  font-size: 50px;
                        color: #FFFFFF;">PinDrop App
                </div>
