...
<meta name="description" content="Get free source codes, programming tutorials, forms designs and templates and HTML templates" />
<meta name="keywords" content="HTML, iOS, Delphi, Java, python, templates">
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Other programming languages</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="web"><a href="#" title="">JAVA</a></li>
					<li class="icon"><a href="#" title="">Python</a></li>
					<li class="graphic"><a href="#" title="">scripting langauges</a></li>
				</ul>
				<div class="clearfix">
				</div>
				<div class="row">
